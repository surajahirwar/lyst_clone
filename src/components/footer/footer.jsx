...
export const Footer = () =>{
    ...
    <div className="inner_footer_left">
        ...
        <div className="Learn_about">
            <br />
        <span>Learn about the Lyst app for iPhone, iPad and Android.</span><br /><br />

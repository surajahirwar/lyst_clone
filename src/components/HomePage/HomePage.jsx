...
<div className="catog">
    ...
    <img className="imgbox" src="https://cdna.lystit.com/cms/OSA_24_03_22_09a1fa2732.jpeg" alt=""/>
    </div>
    <div className="box1">
   <h1 className="head1">ONE STEP AHEAD</h1>
    <img  className="imgbox" src="https://cdna.lystit.com/cms/REFINED_GLAMOUR_c966d97813.jpeg" alt=""/>
    </div>
    <div className="box1">
    <h1 className="head1">ONE STEP AHEAD</h1>

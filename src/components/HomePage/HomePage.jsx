...
<div className="catog">
   ...
   <Link to="/women">  <img className="imgbox" src="https://cdna.lystit.com/cms/Image_from_i_OS_570_8c4ba5ce61.png" alt=""/></Link>

    </div>
    <div className="box1">
    <h1 className="head1">ONE STEP AHEAD</h1>
    <Link to="/women"> <img className="imgbox" src="https://cdna.lystit.com/cms/OSA_24_03_22_09a1fa2732.jpeg" alt=""/></Link>
    </div>
    <div className="box1">
   <h1 className="head1">ONE STEP AHEAD</h1>
   <Link to="/women"> <img  className="imgbox" src="https://cdna.lystit.com/cms/REFINED_GLAMOUR_c966d97813.jpeg" alt=""/></Link>
    </div>
    <div className="box1">
    <h1 className="head1">ONE STEP AHEAD</h1>
...
<div className="catog" id="catog">
    ...
    <div className="box1">
    <h1 className="head1">DISCOVER THE ICONIC MYEA BAG -EMPORIO ARMANI</h1>
    <img className="imgbox" src="https://cdna.lystit.com/cms/EA_My_EA_Bags_HP_Top_Lyst_3ab19a30d3.jpg" alt=""/>
    </div>
    <div className="box1">
    <h1 className="head1">MICHEAL KORKS: YOUR FAVOURITE STYLES ARE WAITING FOR SALE</h1>
    <img  className="imgbox" src="https://cdna.lystit.com/cms/LINA_BAG_ASSET_600x600_01800ffbe1.jpg" alt=""/>
    </div>
    <div className="box1">
...
<div id="offzone"> 
    ...
    <div className="head3"><h1 className="head3_h12">BALENCIAGA T-SHIRTS</h1>  <img className="imgbox2" src="https://cdna.lystit.com/cms/designer_category_mens_balenciaga_t_shirts_2c33757129.jpeg" alt=""/></div>
       ...
       <div className="head3"><h1 className="head3_h12">CAMILLA DRESSES</h1>  <img className="imgbox2" src="https://cdna.lystit.com/cms/designer_category_camilla_dresses_ed5dbcc2dc.jpeg" alt=""/></div>
        </div>
</div>
